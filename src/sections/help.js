...
export default class Help extends Component {
    ...
    render() {
        return (
            <div id="help" onClick={this.handleClose} className={`settings_overlay overlay fader${this.state.shown ? " fader_shown" : ""}`}>
                <div className="settings_container" onClick={this.handleStopClose}>
                    ...
                    <div className="overlay_contents">
                        ...
                        <h3>Usage</h3>
                        <p>
                            Input text into the main editor field. Assemble using the <img src="Images/assembleHelp.png" className="help_icon" alt="assemble" /> button. You can press <img src="Images/assemblePlayHelp.png" className="help_icon" alt="assemble + play" /> to assemble, and then start the simulation. Alternatively, when you have a blank codebase but you have machine code, if you press <img src="Images/playHelp.png" className="help_icon" alt="play" /> you can simply directly simulate the machine code.
                        </p>
                        <p>
                        ...
                        <p>
                            To do it, go to the file menu in the top left of the editor, and and press "Load Binary" or "Load Assembly" to upload a file. Keep in mind, binaries and assembly files must be in the correct file. After assembly files are uploaded, you need to press the assemble <img src="Images/assembleHelp.png" className="help_icon" alt="assemble" /> button. After either that or the binary file, you must press play <img src="Images/playHelp.png" className="help_icon" alt="play" />.
                        </p>
                        <h4>Downloading</h4>
                        <p>
